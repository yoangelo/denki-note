class Admin::BankAccountsController < AuthenticatedController
  ...
  def index
    ...
    render json: {
      bank_accounts: bank_accounts.map { |ba| bank_account_json(ba, masked: true) },
    }
  end
  ...
  def show
    render json: {
      bank_account: bank_account_json(@bank_account, masked: false),
    }
  end
  ...
  def bank_account_params
    params.require(:bank_account).permit(
      :bank_name, :branch_name, :account_type, :account_number, :account_holder, :is_default_for_invoice
    )
  end

  def bank_account_json(bank_account, masked: true)
    {
      id: bank_account.id,
      bank_name: bank_account.bank_name,
      branch_name: bank_account.branch_name,
      account_type: bank_account.account_type,
      account_number: masked ? bank_account.masked_account_number : bank_account.account_number,
